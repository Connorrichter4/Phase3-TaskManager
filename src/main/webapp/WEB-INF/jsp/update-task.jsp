...
<body>
	...
	<form:form method="post">
		<label for="name">Task Name:</label> <input type="text" id="name"
			name="name" value="${task.name}"><br>
		<br> <label for="startdate">Start Date:</label> <input
			type="date" id="startdate" name="startDate" value=<fmt:formatDate pattern = "yyyy-MM-dd" value = "${task.startDate}" />><br>
		<br> <label for="enddate">End Date:</label> <input type="date"
			id="enddate" name="endDate" value=<fmt:formatDate pattern = "yyyy-MM-dd" value = "${task.endDate}" />><br>
		...
		<br> <label for="email">Email:</label> <input type="text"
			id="email" name="email" value="${task.email}"><br>
